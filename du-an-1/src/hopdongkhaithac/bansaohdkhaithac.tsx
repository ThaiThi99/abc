    ...
    <>
      <div style={{ width: "100%", display: "flex" }}>
        ...
        <div className="hdqbh3">
          <p className="hdqbhh3">Bản sao hợp đồng khai thác - HD123</p>
        </div>
        ...
        <div className="khd3">
          ...
          <div style={{ marginBottom: 40 }}> Tình trạng:</div>
        </div>
        ...
        <div
          ...
          className="hdqbh3 "
        >
          <input className="ip3" defaultValue={1421566747} />
          <input
            className="ip3"
        ...
        <div className="textttuq3">Thông tin pháp nhân uỷ quyền</div>
...
export default BansaoHDKhaiThac;
